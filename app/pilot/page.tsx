...
const steps = [
  {
    ...
    desc: "We start with a deep-dive into how your recruitment firm actually operates â€” not how it's supposed to on paper. We map your full workflow, identify which tools you're using (and which ones are creating friction), and pinpoint the exact points where time, candidates, or placements are slipping through the cracks. No assumptions. No generic templates.",
    icon: (
  ...
  },
  {
    ...
    desc: "We build everything and connect it directly into your existing tools â€” your ATS, CRM, outreach platforms, calendar, whatever you're running. No disruption to your team's current setup. We handle the technical side entirely: building the automations, deploying the AI agents, and making sure everything runs reliably before the testing period begins.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "You run with the full solution for 30 days at zero cost. This is real-world testing inside your actual operations â€” not a demo environment. We stay close throughout: monitoring performance, making adjustments, and measuring the impact against the specific problems we identified in Step 1.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
...
export default function PilotPage() {
  return (
    <SiteLayout>
      ...
      <section className="relative overflow-hidden bg-[#071C2E] pt-40 pb-28 px-6">
        ...
        >
          <span className="inline-block mb-6 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase border"
            ...
            Limited Availability â€” Pilot Program
          </span>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-8 text-slate-500 leading-relaxed">
              <div className="space-y-4">
                <p>
                  HireNove is a new consultancy. Rather than making promises based on credentials alone, I want to earn your trust the harder way â€” by actually solving a real problem inside your business, at my risk, not yours.
                </p>
                <p>
                  The Pilot Program exists because I believe the best way to learn how recruitment operations work in practice is to be inside one. Every firm runs differently. Every stack is different. Every team has different pressure points.
                </p>
              </div>
              <div className="space-y-4">
                <p>
                  By working with a small number of firms through our Pilot Program, we gain hands-on experience building solutions that run in real environments â€” not test scenarios. You get a functioning workflow improvement without any financial exposure.
                </p>
                <p>
      ...
      {/* What's included callout â€” dark */}
      <section className="relative overflow-hidden py-16 px-6" style={{ background: "#071C2E" }}>
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { label: "Fully custom", desc: "Built for your specific workflow â€” not a template dropped into your stack." },
