    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family:Inter,sans-serif;max-width:560px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
          <div style="background:#1A0F2E;padding:32px 40px;">
          ...
          <div style="padding:32px 40px;">
            <table style="width:100%;border-collapse:collapse;font-size:14px;color:#374151;">
              ...
              <tr><td style="padding:8px 0;font-weight:600;color:#6b7280;">Email</td><td style="padding:8px 0;"><a href="mailto:${email}" style="color:#5B21B6;">${email}</a></td></tr>
              <tr><td style="padding:8px 0;font-weight:600;color:#6b7280;">Role</td><td style="padding:8px 0;">${role || "—"}</td></tr>
            </table>
            ${bottleneck ? `
            <div style="margin-top:20px;padding:16px;background:#f8f5ff;border-radius:8px;border-left:3px solid #5B21B6;">
              <p style="font-size:11px;font-weight:700;color:#5B21B6;letter-spacing:0.08em;text-transform:uppercase;margin:0 0 6px;">Biggest bottleneck</p>
              <p style="font-size:14px;color:#374151;margin:0;line-height:1.6;">${bottleneck}</p>
            </div>` : ""}
            <div style="margin-top:28px;">
              <a href="mailto:${email}" style="display:inline-block;padding:12px 24px;background:#5B21B6;color:#ffffff;font-weight:600;font-size:14px;border-radius:8px;text-decoration:none;">Reply to ${name}</a>
            </div>
          </div>
        </div>
      `,
