        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              {/* Photo */}
              <div
                className="relative w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden float-anim"
              ...
              <motion.div
                ...
                className="absolute -bottom-4 left-1/2 -translate-x-1/2 glass rounded-2xl px-5 py-3 text-center whitespace-nowrap"
              >
                <p className="font-display font-semibold text-white text-sm">Anisa Leci</p>
                <p className="text-violet-400 text-xs font-medium">Founder, HireNove</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-widest text-violet-400 mb-3">About</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <a
                href="#discovery"
                className="inline-flex items-center justify-center px-6 py-3.5 bg-violet-600 hover:bg-violet-500 text-white font-semibold rounded-xl text-sm transition-all duration-200"
              >
                Work with HireNove
              </a>
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl text-white/50 hover:text-white text-sm font-medium transition-all duration-200"
